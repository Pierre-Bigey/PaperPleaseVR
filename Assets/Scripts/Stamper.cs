...
public class Stamper : MonoBehaviour
{
    ...
    [SerializeField] private bool accesGranted;
    ...
    private void Stamp(RaycastHit hit )
    {
        ...
        PassportScript passportScript = passport.transform.parent.GetComponent<PassportScript>();
        passportScript.Stamp(accesGranted);
